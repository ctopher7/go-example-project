...
// Expire provides a mock function with given fields: ctx, key, expiry
func (_m *MockRepository) Expire(ctx context.Context, key string, expiry time.Duration) (bool, error) {
