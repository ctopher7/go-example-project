...
const (
	Ohlc_GetSummary_FullMethodName = "/proto.Ohlc/GetSummary"
)
...
func (c *ohlcClient) GetSummary(ctx context.Context, in *GetSummaryRequest, opts ...grpc.CallOption) (*GetSummaryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Ohlc_GetSummary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Ohlc_GetSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Ohlc_GetSummary_FullMethodName,
	}
...
var Ohlc_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "part1/proto/ohlc.proto",
}
